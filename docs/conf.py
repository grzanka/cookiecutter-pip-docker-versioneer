...
try:
    release = pkg_resources.get_distribution('onehundredseven').version
except pkg_resources.DistributionNotFound:
    print('onehundredseven must be installed to build the documentation.')
